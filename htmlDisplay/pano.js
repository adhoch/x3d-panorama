...
/*$('#x3dcontext').on('mouseover keypress',  function (e) {console.log('hover')
v=true;
...
function handleGroupClick(event) {
    ...
    if (event.button == '2') {
        ...
        $('scene').append('<Shape id="drawnShape' + b + '"><Appearance><Material emissiveColor="1 0 0"/></Appearance><IndexedFaceSet solid="false" coordIndex="' + coordIndex + ' 0 -1"><Coordinate point="' + points + '"/></IndexedFaceSet></Shape>');
...
function fullscreen(button) {
    ...
    x3dcontext.style.width = new_size;
    x3dcontext.style.height = new_size;
}